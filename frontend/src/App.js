...
const SIDEBAR_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'bull_breakout_vol', label: 'High Breakout + Vol',  icon: '🚀', badge: 'NEW' },
      { id: 'gap_up_vol',       label: 'Gap Up Opening',       icon: '🔼', badge: 'NEW' },
      { id: 'btst_bull',        label: 'BTST Candidate',       icon: '🌙', badge: 'NEW' },
      { id: 'beginner_pick',    label: 'Beginner Friendly',    icon: '🎓', badge: 'HOT' },
    ],
  },
  {
    label: 'Trend & Signal',
    items: [
      ...
      { id: 'ema200_cross',     label: '200 EMA Reclaim',      icon: '🌟', badge: 'NEW' },
      { id: 'sma20_breakout',   label: '20 SMA Breakout',      icon: '📐', badge: 'NEW' },
      { id: 'strong_momentum',  label: 'Strong Momentum',      icon: '⚡', badge: 'NEW' },
      { id: 'delivery_strong',  label: 'Delivery Strength',    icon: '📦', badge: 'NEW' },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'accumulation', label: 'Accumulation Pattern',  icon: '🏦' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'low_reversal', label: 'Near 52W Low',          icon: '🔄', badge: 'NEW' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'value_screen',   label: 'Value Metrics',         icon: '💰' },
